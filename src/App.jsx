...
function App() {
  ...
  const fetchTotal = async () => {
    ...
    try {
      const res = await fetch('https://bc2ce8eba956.ngrok-free.app/lavagem/totalamount')
  ...
  const loadPhotos = async () => {
    ...
    try {
      const response = await fetch('https://bc2ce8eba956.ngrok-free.app/lavagem', {
        method: 'GET',
        headers: {
      ...
      setPhotos(data.map(item => ({
        id: item.id || item._id,
        image: `https://bc2ce8eba956.ngrok-free.app/files/images/${item.image_url}`,
        pago: item.charge,
  ...
  const updatePaymentStatus = async (id, pago) => {
    ...
    try {
      const response = await fetch(`https://bc2ce8eba956.ngrok-free.app/lavagem/${id}/charge`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          // 'Authorization': 'Bearer SEU_TOKEN'
  ...
  const updatePaymentMethod = async (id, formaPagamento) => {
    ...
    try {
      const response = await fetch(`https://bc2ce8eba956.ngrok-free.app/lavagem/${id}/payment_method`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          // 'Authorization': 'Bearer SEU_TOKEN'
  ...
  const updatePaymentValue = async (id, valor) => {
    ...
    try {
      ...
      const response = await fetch(`https://bc2ce8eba956.ngrok-free.app/lavagem/${id}/amount`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          // 'Authorization': 'Bearer SEU_TOKEN'
  ...
  const deletePhoto = async (id) => {
    try {
      const response = await fetch(`https://bc2ce8eba956.ngrok-free.app/lavagem/${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        }
